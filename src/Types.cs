...
namespace Portfish
{
    ...
    internal sealed class StateInfoArray
    {
        ...
        {
            for (var i = 0; i < (Constants.MAX_PLY_PLUS_2); i++)
            {
                this.state[i] = new StateInfo();
            }
        }
    }
    ...
    {
        internal readonly MoveStack[] moves = new MoveStack[Constants.MAX_MOVES + 2];
    ...
    internal sealed class LoopStack
    {
        ...
        public void Recycle()
        {
            Array.Clear(this.ss, 0, Constants.MAX_PLY_PLUS_2);
        }
    }
    ...
    {
        internal readonly int[] movesSearched = new int[Constants.MAX_MOVES];
    }

    // Different node types, used as template parameter
    internal static class NodeTypeC
    {
        internal const int Root = 0, PV = 1, NonPV = 2, SplitPointRoot = 3, SplitPointPV = 4, SplitPointNonPV = 5;
    };
    ...
    internal static class TimeTypeC
    {
        internal const int OptimumTime = 0, MaxTime = 1;
    };
    ...
    {
        internal const int SCALE_FACTOR_DRAW = 0,
    ...
    {
        internal const int VALUE_ZERO = 0,
                           VALUE_DRAW = 0,
